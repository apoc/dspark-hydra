...
def per_domain_gate_mass(dump_dir: str, num_experts: int = 256, source: str = "star") -> dict[int, torch.Tensor]:
...
def group_domain_composition(dump_dir: str, C: torch.Tensor, k_prime: int = 2, source: str = "star") -> torch.Tensor:
